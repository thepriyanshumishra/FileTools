...
export default function AdminDashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800">
      {/* Header */}
      <div className="border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-lg sticky top-0 z-10">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Manage FileTools</p>
            </div>
            <Link
              href="/"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white text-sm font-medium hover:shadow-lg transition-all"
            >
      ...
      <div className="container mx-auto px-6 py-8">
          ...
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all ${
                activeTab === tab.id
                  ? 'bg-white dark:bg-zinc-800 shadow-lg text-purple-600'
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: 'Total Tools', value: totalTools, color: 'from-blue-500 to-blue-600' },
                { label: 'Working', value: workingTools, color: 'from-green-500 to-green-600' },
                { label: 'Conversions', value: history.length, color: 'from-purple-500 to-purple-600' },
                { label: 'Favorites', value: favorites.length, color: 'from-yellow-500 to-yellow-600' },
              ].map((stat) => (
                <motion.div
                  key={stat.label}
        ...
        {activeTab === 'tools' && (
          <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-lg">
            <h2 className="text-lg font-bold mb-6">Tools Management</h2>
            <div className="space-y-6">
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-lg">
              <h2 className="text-lg font-bold mb-6">Maintenance Mode</h2>
              <div className="space-y-4">
